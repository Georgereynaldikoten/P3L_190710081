                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('employees.update', $employees->id) }}" method="POST"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ $employees->employee_name }}" required autocomplete="name" autofocus>
                                    @error('name')
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="phone" type="text"
                                        ...
                                        name="employee_phone_number" value="{{ $employees->employee_phone_number }}"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="address" type="text"
                                        ...
                                        name="employee_address" value="{{ $employees->employee_address }}" required
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="birthdate" type="date"
                                        ...
                                        name="employee_birth_date" value="{{ $employees->employee_birth_date }}"
                            ...
                            <!-- Employee Role -->
                            <?php $roles = DB::table('roles')->where('id', $employees->id_role)->first(); ?>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <select name="employee_gender" id="employee_gender" class="form-control">
                                        <option value="{{ $employees->employee_gender }}">
                                            {{ $employees->employee_gender }}</option>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="employee_image" type="file"
                                        class="form-control @error('employee_image') is-invalid @enderror"
                                        name="employee_image" value="{{ $employees->employee_image }}" required
                                        autocomplete="employee_image">
                            ...
                            <div class="form-group row mb-0">
                                <div class="col-md-6 offset-md-4">
                                    <button type="submit" class="btn btn-primary" onclick="return confirm('Anda yakin ingin mengupdate data?')">
                                        {{ __('Update') }}
                                    </button>
                                </div>
                            </div>
