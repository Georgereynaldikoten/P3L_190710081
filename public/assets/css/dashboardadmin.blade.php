    ...
    <div class="row">
            ...
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        ...
                        <br>
                        <p class="mb-0">Berisi data mobil yang disewakan oleh Atma Jogja Rental</p>
                    </div>
                </div>
        ...
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                ...
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
                    <p class="mb-0">Click<a href="{{route('employees.index')}}"> <b>Here</b></a> to view more</p>
                </div>
            </div>
        </div>
        <!-- driver -->
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                ...
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
                    <p class="mb-0">Click<a href="{{route('drivers.index')}}"> <b>Here</b></a> to view more</p>
                </div>
            </div>
        </div>
        <!-- Mitra -->
        <div class="col-xl-3 col-sm-6 mb-xl-0 mb-4">
            <div class="card">
                <div class="card-header p-3 pt-2">
                    ...
                    <div class="text-end pt-1">
                        <h4 class="mb-0 text-capitalize">Mitra Data</h4>
                        <br>
                        <p class="mb-0">Berisi data Mitra yang berafiliasi dengan Atma Jogja Rental</p>
                    </div>
                </div>
                <hr class="dark horizontal my-0">
                <div class="card-footer p-3">
                    <p class="mb-0">Click<a href="{{route('mitras.index')}}"> <b>Here</b></a> to view more</p>
                </div>
            </div>
        </div>
    </div>
